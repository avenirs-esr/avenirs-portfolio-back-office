...
public enum EAdditionalSkillConfiguration implements EConfiguration {
  ...
  LEVEL_BEGINNER_DESCRIPTION,
  LEVEL_INTERMEDIATE_LABEL,
  LEVEL_INTERMEDIATE_DESCRIPTION,
  LEVEL_COMPETENT_LABEL,
  LEVEL_COMPETENT_DESCRIPTION,
  LEVEL_ADVANCED_LABEL,
  LEVEL_ADVANCED_DESCRIPTION,
  LEVEL_EXPERT_LABEL,
  LEVEL_EXPERT_DESCRIPTION,
}
