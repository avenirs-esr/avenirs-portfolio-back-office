...
class GroupQueryControllerIT extends ContainerConfigurationTest {
  ...
  /**
   * Resolving a seeded group walks its institution and its parent, so it has to happen inside the
   * transaction of a test method rather than in {@code @BeforeAll}.
   */
